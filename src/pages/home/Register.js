...
function Register() {
  return (
    <Box className='flex flex-col w-full h-full mb-6'>
      <div className='flex flex-col relative top-28 bg-white p-20 z-50 rounded border-2 border-gray-100 mx-80 '>
        <span className='font-bold text-[54px] text-center w-full p-[1.4rem] sm:text-[2.4rem] sm:p-[10px]'>
          Let's stay in touch
        </span>
        ...
        <Box className='flex items-center place-self-center gap-5 mt-10 w-2/3 '>
          <Box className='flex justify-items-center gap-x-10 md:gap-y-10 place-self-center md:flex-row sm:w-full md:w-full '>
            <TextField
              id='standard-number'
              label='Email Address'
              InputLabelProps={{
