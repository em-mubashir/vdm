...
function Register() {
  return (
    <Box className='flex flex-col w-full h-full mb-6 xs:m-5 xs:mb-0 xs:ml-[3.5rem] xs:w-[80%] xs:mb-20'>
      <div className='flex flex-col relative top-28 bg-white p-20 z-50 rounded border-2 border-gray-100 mx-80 xs:mx-0 xs:top-0 xs:p-10'>
