...
const SectionClientSay = ({ className = "", uniqueClassName = "" }) => {
  const UNIQUE_CLASS = `SectionClientSay_glide_${uniqueClassName}` + 112121;
    ...
    return (
      <div className='hidden md:block'>
        <img
          ...
          src={`${process.env.PUBLIC_URL}/assets/clientSay1.png`}
          alt=''
        />
        <img
          className='absolute bottom-[100px] right-full mr-40'
          src={`${process.env.PUBLIC_URL}/assets/clientSay2.png`}
          alt=''
        />
        <img
          className='absolute top-full left-[140px]'
          src={`${process.env.PUBLIC_URL}/assets/clientSay3.png`}
          alt=''
        />
        <img
          className='absolute -bottom-10 right-[140px]'
          src={`${process.env.PUBLIC_URL}/assets/clientSay4.png`}
          alt=''
        />
        <img
          className='absolute left-full ml-32 bottom-[80px]'
          src={`${process.env.PUBLIC_URL}/assets/clientSay5.png`}
          alt=''
        />
        <img
          className='absolute -right-10 top-10 '
          src={`${process.env.PUBLIC_URL}/assets/clientSay6.png`}
          alt=''
        />
      </div>
    );
  ...
  return (
    ...
    >
      ...
      <div className='relative md:mb-16 max-w-2xl mx-auto'>
        ...
        <img
          className='mx-auto'
          src={`${process.env.PUBLIC_URL}/assets/clientSayMain.png`}
          alt=''
        />
        <div className={`mt-12 lg:mt-16 relative ${UNIQUE_CLASS}`}>
          <img
            className='opacity-50 md:opacity-100 absolute -mr-16 lg:mr-3 right-full top-1'
            src={`${process.env.PUBLIC_URL}/assets/quotationImg.png`}
            alt=''
          />
          <img
            className='opacity-50 md:opacity-100 absolute -ml-16 lg:ml-3 left-full top-1'
            src={`${process.env.PUBLIC_URL}/assets/quotationImg2.png`}
            alt=''
          />
